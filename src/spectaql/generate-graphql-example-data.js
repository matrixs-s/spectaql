...
export function generateQuery({
  ...
  if (
    extensions?.addManualResponseForJsonType &&
    extensions?.manualResponseJsonFile &&
    extensions.apiResponseJson[field.name]
  ) {
    response.data[field.name] = extensions.apiResponseJson[field.name]
  } else {
    response.data[field.name] = introspectionQueryOrMutationToResponse({
      field,
      introspectionResponse,
      introspectionManipulator,
      extensions,
